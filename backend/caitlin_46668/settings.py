"""
Django settings for caitlin_46668 project.
...
ROOT_URLCONF = 'caitlin_46668.urls'
...
WSGI_APPLICATION = 'caitlin_46668.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "caitlin_46668 API",
    "DESCRIPTION": "API documentation for caitlin_46668 App",
    "VERSION": "v1",
}
